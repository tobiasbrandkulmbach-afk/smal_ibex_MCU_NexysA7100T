...
#   out/demo_ibex_uart_seg7.bit   (Bitstream)
#   out/demo_ibex_uart_seg7.mmi   (Memory-Map, via write_mem_info)
#
# Ablauf zum Programm-Wechsel:
#   1) C neu bauen  -> deployments/.../firmware: cmake --build build
#      (schreibt deployments/demo_ibex_uart_seg7/imem.mem)
