# Load demo_ibex_uart_seg7.bit onto Nexys A7-100T over JTAG (volatile).
# Run:
#   vivado -mode batch -source deployments/demo_ibex_uart_seg7/scripts/program.tcl

set script_dir [file dirname [file normalize [info script]]]
set deploy_dir [file dirname $script_dir]
set bit_file   $deploy_dir/out/demo_ibex_uart_seg7.bit
