## Nexys A7-100T pin constraints for demo_counter_ram_seg7
...
## Buttons (all active-HIGH on the board)
set_property -dict { PACKAGE_PIN N17   IOSTANDARD LVCMOS33 } [get_ports { btnc_i }];   ## BTNC – reset
set_property -dict { PACKAGE_PIN M18   IOSTANDARD LVCMOS33 } [get_ports { btnu_i }];   ## BTNU – addr up
set_property -dict { PACKAGE_PIN P18   IOSTANDARD LVCMOS33 } [get_ports { btnd_i }];   ## BTND – addr down

## Switches
set_property -dict { PACKAGE_PIN J15   IOSTANDARD LVCMOS33 } [get_ports { sw0_i }];    ## SW0 – bank select
