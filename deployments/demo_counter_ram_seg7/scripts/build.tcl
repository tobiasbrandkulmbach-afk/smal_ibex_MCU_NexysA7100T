# Vivado non-project batch build for demo_counter_ram_seg7.
# Run from anywhere:
#   vivado -mode batch -source deployments/demo_counter_ram_seg7/scripts/build.tcl
# Output bitstream: deployments/demo_counter_ram_seg7/out/demo_counter_ram_seg7.bit
