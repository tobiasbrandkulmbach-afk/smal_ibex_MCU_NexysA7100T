## Nexys A7-100T pin constraints for demo_counter_seg7
...
set_property -dict { PACKAGE_PIN M18   IOSTANDARD LVCMOS33 } [get_ports { btnu_i }];   ## BTNU – count up
set_property -dict { PACKAGE_PIN P18   IOSTANDARD LVCMOS33 } [get_ports { btnd_i }];   ## BTND – count down
